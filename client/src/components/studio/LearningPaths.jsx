...
const GlowCard = ({ children }) => {
  return (
    <div className="w-full relative group">
      {/* Glow Layer */}
      <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 rounded-2xl opacity-20 blur-lg group-hover:opacity-40 transition duration-700"></div>

      {/* Main Card */}
      <div className="relative bg-[#09090b] border border-white/10 rounded-2xl p-6 shadow-2xl overflow-hidden">
        {/* Grid Background */}
